export default function About() {
    return (
      <div className="justify-items-center pb-content sm:mt-18">
        <main className="grid sm:max-w-1/2 text-center sm:text-justify px-2 sm:px-0">
          ...
          <div className="grid grid-cols-3 sm:max-w-1/2 gap-6 justify-items-center sm:justify-items-start">
